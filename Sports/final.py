    ...
    def logininto():
        ...
        if c==1:
            ...
            def disp():
                ...
                for i in cur10_1:
                    i=list(i)
                    print("ID: "+str(i[0])+"  Name: "+i[2]+"  Match played: "+str(i[3])+"  Match won: "+str(i[4]))
                cur10_1.close()
                cur10_2 = conn.cursor()
                ...
                for j in cur10_2:
                    j=list(j)
                    print("ID: "+str(j[0])+"  Name: "+j[1]+"  Match played: "+str(j[3])+"  Match won: "+str(j[4]))
                cur10_2.close()
...
def fixtures():
    ...
    if count<8:
        ...
        def play33():
            cur8_1 = conn.cursor()
            ins8_1 = "select * from fixture where g_no=7"
            ...
            b6_1 = Button(root8, text="  ||OVER|| ", borderwidth=4, command=close)
            b6_1.place(x=175, y=750)
        ...
        b5_8 = Button(root5, text="  EXIT  ", borderwidth=4, command=over)
